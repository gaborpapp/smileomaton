...
#ifndef OFX_SOUNDPLAYER_SOUND_H
#define OFX_SOUNDPLAYER_SOUND_H
...
public :
    ...
    ///
    ////////////////////////////////////////////////////////////
    Sound(const SoundBuffer& Buffer, bool Loop = false, float Pitch = 1.f, float Volume = 100.f, const ofxVec3f& Position = ofxVec3f(0, 0, 0));
    ...
    ///
    ////////////////////////////////////////////////////////////
    void SetPosition(const ofxVec3f& Position);
