...
SoundStream::~SoundStream()
{
    ...
    //cout << "soundstream destructor" << endl;
    Stop();
}
...
void SoundStream::Initialize(unsigned int ChannelsCount, unsigned int SampleRate)
{
    ...
    myFormat = AudioDevice::GetInstance().GetFormatFromChannelsCount(ChannelsCount);
...
////////////////////////////////////////////////////////////
Sound::SoundStatus SoundStream::GetStatus() const
{
    SoundStatus status = Sound::GetStatus();
